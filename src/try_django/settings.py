...
BASE_DIR = os.path.realpath(os.path.dirname(__file__))  # relative path
...
SECRET_KEY = '4mjih^9fq-^#a-^dazx+41%4t@on%-u4r5imx_x_^t43k3ml_e'
...
LOCAL_STATIC_CDN_PATH = os.path.join(
    os.path.dirname(BASE_DIR), 'static_cdn_test')  # live, cdn , AWS, S3
